...
///Fin de informacion enviada por el formulario///
...
$sql->bindParam(':fregis',$fregis,PDO::PARAM_STR, 25);
$sql->execute();
...
if ($lastInsertId>0) {
  echo "<div class='content alert alert-primary'> Gracias .. Tu Nombre es : $nombres </div>";
   ...
   echo "<div class='content alert alert-danger'> No se pueden agregar datos, comuniquese con el adiministrador</div>";
